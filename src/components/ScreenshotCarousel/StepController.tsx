...
const Stepper = ({ buttonClassName, svgPath, onClick }: StepperProps) => (
  <button
    ...
    onClick={onClick}
  >
    <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 transition-colors dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60">
      <svg
